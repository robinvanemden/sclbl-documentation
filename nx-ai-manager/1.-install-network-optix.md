...
* Download the [x64 Ubuntu Nx Meta server](https://meta.nxvms.com/download/linux) installer (metavms-server-6.x.x.x-linux\_x64.deb). \
  ...
  *   You can use wget or curl in an SSH session to download the installer files directly to the server:\
      ...
      ```sh
      # For example the the 6.0.2.40414 version for x64 architectures
      wget https://updates.networkoptix.com/metavms/40414/linux/metavms-server-6.0.2.40414-linux_x64.deb

      # Or the 6.0.2.40414 version for ARM64 architectures
      wget https://updates.networkoptix.com/metavms/40414/arm/metavms-server-6.0.2.40414-linux_arm64.deb
      ```
